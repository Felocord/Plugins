...
const pluginBase = "bunny.Felocord.xyz/";
const devPluginBase = "dev.bunny.Felocord.xyz/";

const invalidPlugins = [];
const plugins = [];
const links = {
  // STUB[epic=proxy] vendetta.Felocord.xyz => bunny.Felocord.xyz
  proxied: `https://bn-plugins.github.io/vd-proxy/vendetta.Felocord.xyz/`,
  code: `https://github.com/Felocord/Plugins/tree/${branch}/plugins/`,
  external: {
    backend: "https://github.com/Felocord/",
  },
};
...
const mdNote = `<!--
  ...
  * https://github.com/Felocord/Plugins/edit/${branch}/scripts/readmes.mjs
-->\n`;
...
<div align="center">
  ${makeHref(
    "https://github.com/Felocord/Plugins/stargazers",
    `<img alt="GitHub stars" src="https://img.shields.io/github/stars/Felocord/Plugins?style=for-the-badge&color=${shieldColors.ghstars}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghstars}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/Felocord/Plugins/issues",
    `<img alt="GitHub issues" src="https://img.shields.io/github/issues/Felocord/Plugins?style=for-the-badge&color=${shieldColors.ghissues}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghissues}">`,
    1,
  )}
  ${makeHref(
    "https://github.com/Felocord/Plugins/pulls",
    `<img alt="GitHub pull requests" src="https://img.shields.io/github/issues-pr/Felocord/Plugins?style=for-the-badge&color=${shieldColors.ghpulls}&labelColor=${shieldLabelColor}&logo=${shieldLogos.ghpulls}">`,
    1,
  )}
  ${makeHref(
